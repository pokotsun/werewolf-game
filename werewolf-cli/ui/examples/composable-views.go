...
// sessionState is used to track which listSimpleModel is focused
...
var (
	...
	composableHelpStyle = lipgloss.NewStyle().Foreground(lipgloss.Color("241"))
)
...
func (m mainModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case tea.KeyMsg:
		...
		switch m.state {
		// update whichever listSimpleModel is focused
		case spinnerView:
...
func (m mainModel) View() string {
	...
	s += composableHelpStyle.Render(fmt.Sprintf("\ntab: focus next • n: new %s • q: exit\n", model))
	return s
}
